...
> 第14章で Onion Architecture（レイヤー分割）を学んだ。この章では同じ「商品管理」機能を **Clean Architecture** で実装し直す。同じ機能を別のアーキテクチャで書くことで、思想の違いと使い分けを体験できる。
...
flowchart LR
    ...
    style Entity fill:gray,stroke:#f9a825
    style UseCase fill:gray,stroke:#43a047
    style Adapter fill:gray,stroke:#1e88e5
    style Infra fill:gray,stroke:#e91e63
```
