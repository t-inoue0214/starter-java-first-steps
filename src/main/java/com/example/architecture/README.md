...
> この章のゴールは「**第16章のクリーンアーキテクチャを正しく理解するための前提を作ること**」だ。
>
...
Robert C. Martin（Uncle Bob）が 2012 年に提唱。Onion と同じ思想を「Input Port / Output Boundary / Use Case」という概念で精緻化した。Pull 型（戻り値でデータを取る）から Push 型（Output Boundary を呼ぶ）へとデータの流れが変わる。**← 第16章で実装する**
...
**Onion Architecture を実装してその限界を体感し、第16章へ進もう。**
...
| [← 第14章: 安全なコーディング](../safe_coding/README.md) | [全章目次](../../../../../../README.md) | [第16章: クリーンアーキテクチャ →](../clean_architecture/README.md) |
| :--- | :---: | ---: |
